class MakeReports
  ...
  def perform(report_id)
    ...
    cmd = [script, "\"#{report.column1_file} #{report.column2_file}\"", report.location.lon, report.location.lat, "\"#{report.location.name}\"", report.low_temp_threshold, report.high_temp_threshold]
